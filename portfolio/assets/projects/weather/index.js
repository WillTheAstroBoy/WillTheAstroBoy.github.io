...
async function getWeather(){
	const options = {
		"method": "GET",
		"headers": {
			"x-rapidapi-key": "3471fdee3emshc8cba5444524ad5p130cc9jsn6564444b55ad",
			"x-rapidapi-host": "community-open-weather-map.p.rapidapi.com"
		}
	}

	const getPromise = await fetch(`https://community-open-weather-map.p.rapidapi.com/weather?q=${city}`, options);
